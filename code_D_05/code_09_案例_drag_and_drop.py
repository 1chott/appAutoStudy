...
buletooth_feature = (By.XPATH, '//*[@text="蓝牙"]')

storage_btn = get_ele(storage_feature)
buletooth_btn = get_ele(buletooth_feature)

# drag_and_drop(开始元素对象， 结束元素对象)  拖拽，没有惯性
driver.drag_and_drop(storage_btn, buletooth_btn)
