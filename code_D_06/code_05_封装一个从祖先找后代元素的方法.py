...
# 封装方法， 传父类和子类的feature
def get_ele_by_father(father_feature, son_feature):
    father_ele = get_ele(father_feature)
...
# tab_ele = driver.find_element(*tab_feature)
#
# me_feature = (By.XPATH, '//*[@text="我"]')
#
# me_ele = tab_ele.find_element(*me_feature)
# me_ele.click()

tab_feature = (By.ID, 'android:id/tabs')
me_feature = (By.XPATH, '//*[@text="我"]')

me_ele = get_ele_by_father(tab_feature, me_feature)
me_ele.click()
